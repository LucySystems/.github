...
- **Memory that compounds.** Multi-day continuity, trend awareness, and pattern detection — so the system actually knows you over time instead of resetting every conversation.
